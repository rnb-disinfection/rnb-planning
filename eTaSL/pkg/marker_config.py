...
def get_aruco_config():
    ...
    aruco_map = {
        'indy0': MarkerSet('indy0', ttype=TargetType.ROBOT, _list=[
        ...
        'panda1':MarkerSet('panda1', ttype=TargetType.ROBOT, _list=[
        ...
        'floor':MarkerSet('floor', ttype=TargetType.ENVIRONMENT, gtype=GEOTYPE.BOX, dims=(1.52,0.72,0.016),
                          _list=[
        ...
        'wall':MarkerSet('wall', ttype=TargetType.ENVIRONMENT, gtype=GEOTYPE.BOX, dims=(3,3,0.01),
                         _list=[
        ...
        'box2':MarkerSet('box2',
            ttype=TargetType.MOVABLE, gtype=GEOTYPE.BOX, dims=(0.05, 0.05,0.05), color=(0.3,0.3,0.8,1),
            _list=[
        ...
        'box3':MarkerSet('box3',
            ttype=TargetType.MOVABLE, gtype=GEOTYPE.SPHERE, dims=(0.15,0.15,0.15), color=(0.8,0.8,0.0,0.3),
            soft=True, K_col=100,
            _list=[
        ...
        'goal':MarkerSet('goal',
            ttype=TargetType.MOVABLE, gtype=GEOTYPE.BOX, dims=(0.1, 0.1,0.01), color=(0.8,0.0,0.0,1),
            _list=[
