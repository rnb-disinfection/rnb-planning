...
#     params = aruco.DetectorParameters_create()
    ...
    aruco_map = {'indy0':[ObjectMarker(11, 0.05, SE3(Rot_zyx(0,0,np.pi), [-0.07,0.12,0])),
                          ObjectMarker(12, 0.05, SE3(Rot_zyx(0,0,np.pi), [0.12,0.12,0])),
                          ObjectMarker(13, 0.05, SE3(Rot_zyx(0,0,np.pi), [0.12,-0.12,0])),
                          ObjectMarker(14, 0.05, SE3(Rot_zyx(0,0,np.pi), [-0.07,-0.12,0]))
                         ],
                 'panda1':[ObjectMarker(21, 0.05, SE3(Rot_zyx(0,0,np.pi), [-0.128,0.12,0])),
                          ObjectMarker(22, 0.05, SE3(Rot_zyx(0,0,np.pi), [0.112,0.12,0])),
                          ObjectMarker(23, 0.05, SE3(Rot_zyx(0,0,np.pi), [0.112,-0.12,0])),
                          ObjectMarker(24, 0.05, SE3(Rot_zyx(0,0,np.pi), [-0.128,-0.12,0]))
                         ],
