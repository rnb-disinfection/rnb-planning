...
import subprocess
f = open('{}robots/custom_robots.urdf'.format(TF_GMT_ETASL_DIR), "w")
f.write(subprocess.check_output(['xacro', '{}robots/custom_robots.urdf.xacro'.format(TF_GMT_ETASL_DIR)]))
f.close()
