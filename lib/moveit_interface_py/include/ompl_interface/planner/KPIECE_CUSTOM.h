//
// Created by rnb on 21. 5. 6..
//

#ifndef MOVEIT_INTERFACE_PY_KPIECE_CUSTOM_H
#define MOVEIT_INTERFACE_PY_KPIECE_CUSTOM_H
...
namespace ompl
{
    namespace geometric
    {
        ...
        */
        ...
        class KPIECE_CUSTOM : public base::Planner
        {
        public:
            /** \brief Constructor */
            KPIECE_CUSTOM(const base::SpaceInformationPtr &si);

            ~KPIECE_CUSTOM() override;
...
#endif //MOVEIT_INTERFACE_PY_KPIECE_CUSTOM_H
