...
namespace RNB {
    ...
    namespace OMPLCompact {
        ...
        /** \class RNB::OMPLCompact::CartPose
         */
        ...
        /**
         * @brief Get Eigen::Affine3d from RNB::OMPLCompact::CartPose
         * @author Junsu Kang
         */
        ...
        /** \class RNB::OMPLCompact::GeometryList
         */
