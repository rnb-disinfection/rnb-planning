...
using namespace RNB::OMPLCompact;
...
ros::NodeHandlePtr RNB::OMPLCompact::init_ros(string name) {
    ...
    PRINT_FRAMED_LOG("rosnode ompl_interface_py initialized");
