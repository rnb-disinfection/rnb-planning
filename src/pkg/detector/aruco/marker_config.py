    ...
    aruco_map = ArucoMap(dictionary=dictionary, _dict={
        'vive_ref':MarkerSet('vive_ref', dlevel=DetectionLevel.ENVIRONMENT, gtype=GEOTYPE.BOX, dims=(0.4,0.3,0.01),
                          ...
                          _list=[
                              ...
                              ObjectMarker('vive_ref', 2, 0.05, [0.1, -0.05,0.0], (0,0,0)),
                              ObjectMarker('vive_ref', 3, 0.05, [0.1, 0.05,0.0], (0,0,0)),
                              ObjectMarker('vive_ref', 4, 0.05, [-0.1, 0.05,0.0], (0,0,0))
                          ]),
        ...
        'dl_test': MarkerSet('dl_test',
                                 dlevel=DetectionLevel.MOVABLE, gtype=GEOTYPE.BOX, dims=(0.1, 0.1, 0.01),
                                 color=(0.8, 0.0, 0.0, 1),
                                 _list=[
                                     ObjectMarker('t1', 230, 0.15,
                                                  [-0.116+0.075, 0.415, 0.164-0.075],
                                                  (-1.57079633, -0.        ,  0.        )),
                                     ObjectMarker('t2', 231, 0.15,
                                                  [0.203+0.075, 0.558,  0.228-0.075],
                                                  (-1.57079633, -0.        ,  0.        )),
                                     # ObjectMarker('t3', 232, 0.15,
                                     #              [0.221, 0.0, 0.162],
                                     #              (-1.57079633, -0.        ,  0.        )),
                                     # ObjectMarker('tbed4', 233, 0.15,
                                     #              [0.48249638, -0.04557118, -1.06113917],
                                     #              (-0.13945715, -1.10989934, -0.05032708))
                                     ObjectMarker('t5', 234, 0.15,
                                                  [0.262+0.075, 0.428-0.075, 0.008],
                                                  (-3.14159265, -0.        ,  0.        )),
                                     ObjectMarker('t6', 235, 0.15,
                                                  [-0.255+0.075, 0.164-0.075, 0.008],
                                                  (-3.14159265e+00, -9.60846804e-18,  7.85398163e-02))
                                 ])
    })
    return aruco_map
