...
from shared_function import shared_fun, CallType, ArgSpec, ResSpec, set_serving, is_serving, serve_forever, SHARED_FUNC_ALL
        ...
        def init(self):
            if not self.initizlied:
                ...
                try:
                    ...
                    print("Success to initialize mmdet model")
                except Exception as e:
