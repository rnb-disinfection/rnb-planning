#ifndef ETASLCPPDRIVER_HPP
#define ETASLCPPDRIVER_HPP
...
namespace KDL {
    ...
    // fwd declaration to avoid including the header files:
    class solver;
    class Context;
    class LuaCtx;
    class PythonObserver;

    class eTaSLCppDriver {
        boost::shared_ptr<solver>     slvr; 
        bool                          etaslread;
        bool                          initialized;
        boost::shared_ptr<Context>    ctx;
        boost::shared_ptr<LuaCtx> lua;
         ...
         */
        bool initialize_feature_variables( double initialization_time, double sample_time, double convergence_crit, DoubleMap& result);
    ...
    public:
         ...
         *
         */
        eTaSLCppDriver(int nWSR, double cputime, double regularization_factor);
         ...
         */
        int initialize(const DoubleMap& initialval, 
